...
const createServer = () => {
	...
	setTimeout(() => {
		...
		let schema = fs.readFileSync("./serverQueriesSchema.graphql", "utf-8")  + fs.readFileSync("./serverMutationSchema.graphql", "utf-8");
...
chokidar.watch(fileName).on("change", () => {
	...
	createServer();
	console.log("Reloading web service date complete");
})
